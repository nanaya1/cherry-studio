# 管路系统的图形符号应遵守的原则 | 管路系统的绘制(GB/T 6567.1~5-2008) | 机械制图和几何精度

<!-- src: https://www.mechtool.cn/drawingandaccuracy/drawingandaccuracy_drawingofpipingsystem.html -->

[
]()
## 管路系统的图形符号应遵守的原则
#### 管路系统的图形符号应遵守的原则
![图](https://www.mechdoc.cn/images/drawingandaccuracy/lg-img/mechanicaldesignmanual/7-1-920-1.png)
[
]()
[ 上一项 ]()
[ 下一项 ]()
