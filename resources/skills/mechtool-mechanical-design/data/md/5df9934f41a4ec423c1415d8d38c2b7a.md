# 管法兰连接用垫片 | 管法兰连接用垫片 | 操作件、小五金及管件

<!-- src: https://www.mechtool.cn/hardwareandpipefittings/hardwareandpipefittings_gasketforpipeflangeconnection.html -->

[
]()
## 管法兰连接用垫片
#### 管法兰连接用垫片
![图](https://www.mechdoc.cn/images/hardwareandpipefittings/lg-img/mechdesignmanual/7-2-1872-2.png)
[
]()
[ 上一项 ]()
[ 下一项 ]()
