# 惯量平行轴定律 | 动力学基本计算 | 机械工程常用公式计算

<!-- src: https://www.mechtool.cn/formular/dynamics_lawofparallelaxesofinertia.html -->
...
计算公式：
Jz=Jc'+m*k2²
刚体对任一轴的转动惯量等于对过质心平行轴的转动惯量加上质量与两轴间距离平方的乘积
设置项：
结果小数位数可选择0-15位(默认12位);惯量平行轴定律计算不涉及角度参数,角度单位设置暂不可用
[
]()
[ 上一项 ]()
[ 下一项 ]()
