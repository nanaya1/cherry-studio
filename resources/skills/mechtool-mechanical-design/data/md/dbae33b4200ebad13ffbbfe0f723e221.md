# 量柱（球）测量距 | 齿厚的测量与计算 | 齿轮传动

<!-- src: https://www.mechtool.cn/geardrive/geardrive_calculationformulaofcross-ball(cylindrical)size.html -->

[
]()
## 量柱（球）测量距
#### 量柱（球）测量距
![图](https://www.mechdoc.cn/images/geardrive/lg-img/mechanicaldesignmanual/7-3-1024.png)
#### 跨球(圆柱)尺寸计算公式
[
]()
[ 上一项 ]()
