# GB/T 1031-2009 产品几何技术规范（GPS）表面结构 轮廓法 表面粗糙度参数及其数值 | 表面结构标准 | 机械制图和几何精度

<!-- src: https://www.mechtool.cn/drawingandaccuracy/drawingandaccuracy_standardofsurfacestructure.html -->
