# 长方形截面 | 各种截面的力学性能 | 机械工程常用公式计算

<!-- src: https://www.mechtool.cn/formular/mechanicalproperties_rectangle.html -->

[
]()
#### 长方形截面一体化计算
更改颜色
![长方形截面一体化计算示意图](https://www.mechdoc.cn/images/formular/各种截面的力学性能-长方形截面一体化计算.gif)
小数位数:
0
1
2
