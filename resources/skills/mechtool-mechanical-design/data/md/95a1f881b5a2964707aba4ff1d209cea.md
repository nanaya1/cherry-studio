# pdf2cad v12.2020.2 汉化单文件版 | pdf2CAD | CAD

<!-- src: https://www.mechtool.cn/CAD/CAD_pdf2cad.html -->

[
]()
## 软件介绍
您可以在 [软件介绍]() 中查看此软件介绍。
## pdf2cad v12.2020.2 汉化单文件版
[
下载地址
]()
扫下面二维码或用微信搜一搜关注Mechtool微信公众号，发送'pdf2cadv12'获取提取码。
[
