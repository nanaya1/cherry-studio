# 常用垫片类型与应用 | 垫片类型、应用及选择 | 密封

<!-- src: https://www.mechtool.cn/seal/seal_gaskettypeandapplicationandselection.html -->

[
]()
## 常用垫片类型与应用
#### 常用垫片类型与应用
![图](https://www.mechdoc.cn/images/seal/lg-img/mechdesignmanual/7-3-335-2.png)
![图](https://www.mechdoc.cn/images/seal/lg-img/mechdesignmanual/7-3-336.png)
[
]()
[ 上一项 ]()
[ 下一项 ]()
