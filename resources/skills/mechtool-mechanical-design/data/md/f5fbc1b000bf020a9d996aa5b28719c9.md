# GB/T 6060.1-2018 表面粗糙度比较样块 第1部分：铸造表面 | 表面结构质量测量器具 | 量具、刃具和工具

<!-- src: https://www.mechtool.cn/measuringandcuttingtools/measuringandcuttingtools_surfacestructurequalitymeasuringinstruments.html -->
