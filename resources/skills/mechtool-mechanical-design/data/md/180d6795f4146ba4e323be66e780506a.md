# 铆钉连接的类型、特点和应用 | 连接件与紧固件

<!-- src: https://www.mechtool.cn/boltsandnuts/boltsandnuts_typescharacteristicsandapplicationsofrivetedconnections.html -->

[
]()
## 铆钉连接的类型、特点和应用
#### 铆钉连接的类型、特点和应用
![图](https://www.mechdoc.cn/images/boltsandnuts/lg-img/mechdesignmanual/7-2-283-1.png)
[
]()
[ 上一项 ]()
[ 下一项 ]()
