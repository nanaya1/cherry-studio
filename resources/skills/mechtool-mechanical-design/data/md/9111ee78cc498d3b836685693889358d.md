# 锚固连接失效的几种主要形式 | 连接件与紧固件

<!-- src: https://www.mechtool.cn/boltsandnuts/boltsandnuts_primarymodesofanchorconnectionfailure.html -->

[
]()
## 锚固连接失效的几种主要形式
#### 锚固连接失效的几种主要形式
![图](https://www.mechdoc.cn/images/boltsandnuts/lg-img/mechdesignmanual/7-2-425-2.png)
[
]()
[ 上一项 ]()
[ 下一项 ]()
