# 椭圆球 | 几何体及物性计算 | 机械工程常用公式计算

<!-- src: https://www.mechtool.cn/formular/index_ellipsoid.html -->

[
]()
更改颜色
![椭圆球一体化计算示意图](https://www.mechdoc.cn/images/formular/常用几何体的面积、体积及重心位置-椭圆球一体化计算.gif)
#### 椭圆球一体化计算
小数位数:
0
1
...
V=4*π*a*b*c/3
设置项:
结果小数位数可选择0-15位(默认12位);椭圆球计算不涉及角度参数,角度单位设置暂不可用
#### 椭圆球体积:
计算公式:V=4*π*a*b*c/3
π=
a=
