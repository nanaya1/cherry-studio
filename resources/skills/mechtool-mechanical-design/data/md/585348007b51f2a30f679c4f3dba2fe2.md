...
<!-- src: https://www.mechtool.cn/calculation/calculation_hydraulicmotorcalculation.html -->
...
液压马达计算参数单位解释：
排量单位mL/rev--毫升/每转；
速度(转速)单位rpm--每分钟转数(r/min)；
rpm --> rad/s
1 rpm = 1(rev)/1(min) = 1(rev)/60(s) = 2π (rad)/60(s) = π/30 (rad/s)
[
]()
[ 上一项 ]()
[ 下一项 ]()
