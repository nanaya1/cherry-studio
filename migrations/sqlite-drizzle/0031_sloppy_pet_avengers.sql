...
CREATE TABLE `__new_mcp_server` (
	...
	CONSTRAINT "mcp_server_install_source_check" CHECK("__new_mcp_server"."install_source" IS NULL OR "__new_mcp_server"."install_source" IN ('builtin', 'manual', 'ai_assisted', 'protocol', 'unknown', 'org'))
);
